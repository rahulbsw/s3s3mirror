...
import static org.cobbzilla.s3s3util.S3ToS3Options.*;
import static org.cobbzilla.s3s3util.TestFile.Clean;
import static org.cobbzilla.s3s3util.TestFile.Copy;
...
public class MirrorTest {
    ...
    public void testDeleteRemoved () throws Exception {
        ...
        main = new S3ToS3Main(new String[]{OPT_VERBOSE, OPT_PREFIX, key,
